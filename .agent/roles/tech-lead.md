...
> **[👤 TECH LEAD]** > *Architecting & Planning Mode*
...
3.  If all OK — update `progress.md` and notify the user.
4.  If there are issues — return the task for rework.
...
- 🎯 **Goal:** <Goal of the specific task>
- 📂 **Specific Files:** Study <list relevant files> before coding.
